        ...
        <section className="bg-white dark:bg-gray-900 ">
            <div className="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
                ...
                <div className="flex flex-col items-center max-w-lg mx-auto text-center">
                    <p className="text-[10rem] font-medium text-blue-500 dark:text-blue-400">
                        ۴۰۴
                    </p>
                    ...
                    <p className="mt-4 text-gray-500 dark:text-gray-400">
                        ما بالا و پایین را جستجو کردیم، اما نتوانستیم آنچه را که به دنبالش هستید پیدا کنیم. بیایید مکان بهتری برای شما پیدا کنیم
                    </p>
                ...
                <div className="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400 ">
                        آخرین نوشته ها را در وبلاگ ما بخوانید
                    </p>
                    <Link
                        href="/weblog"
                        className="inline-flex items-center mt-4 text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline"
                    >
                        <span>آخرین نوشته های ما را دنبال کنید</span>
                        <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
